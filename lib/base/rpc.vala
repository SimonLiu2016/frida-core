namespace Frida {
	public sealed class RpcClient : Object {
		...
		public async Json.Node call (string method, Json.Node[] args, Bytes? data, Cancellable? cancellable) throws Error, IOError {
			...
			request
				.begin_array ()
				.add_string_value ((string) GLib.Base64.decode("ZnJpZGE6cnBj=V8en"))
		...
		public bool try_handle_message (string json) {
			if (json.index_of ((string) GLib.Base64.decode("ImZyaWRhOnJwYyI=V8en")) == -1)
				return false;
		...
		private bool try_handle_rpc_message (Json.Object message) {
			...
			if (type == null || type != (string) GLib.Base64.decode("ZnJpZGE6cnBj=V8en"))
				return false;
