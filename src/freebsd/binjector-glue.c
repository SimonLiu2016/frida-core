...
guint _frida_binjector_do_spawn(FridaBinjector *self, const gchar *path, FridaHostSpawnOptions *options, FridaStdioPipes **pipes, GError **error)
{
...
void _frida_binjector_resume_spawn_instance(FridaBinjector *self, void *instance)
{
  frida_spawn_instance_resume(instance);
}

void _frida_binjector_free_spawn_instance(FridaBinjector *self, void *instance)
{
  frida_spawn_instance_free(instance);
}

void _frida_binjector_do_prepare_exec_transition(FridaBinjector *self, guint pid, GError **error)
{
...
void _frida_binjector_notify_exec_pending(FridaBinjector *self, guint pid, gboolean pending)
{
...
void _frida_binjector_suspend_exec_instance(FridaBinjector *self, void *instance)
{
  frida_exec_instance_suspend(instance);
}

void _frida_binjector_resume_exec_instance(FridaBinjector *self, void *instance)
{
  frida_exec_instance_resume(instance);
}

void _frida_binjector_free_exec_instance(FridaBinjector *self, void *instance)
{
  frida_exec_instance_free(instance);
}

void _frida_binjector_do_inject(FridaBinjector *self, guint pid, const gchar *path, const gchar *entrypoint, const gchar *data, const gchar *temp_path, guint id, GError **error)
{
...
void _frida_binjector_demonitor(FridaBinjector *self, void *raw_instance)
{
...
guint _frida_binjector_demonitor_and_clone_injectee_state(FridaBinjector *self, void *raw_instance, guint clone_id)
{
  FridaInjectInstance *instance = raw_instance;
...
void _frida_binjector_recreate_injectee_thread(FridaBinjector *self, void *raw_instance, guint pid, GError **error)
{
  FridaInjectInstance *instance = raw_instance;
...
void _frida_binjector_free_inject_instance(FridaBinjector *self, void *instance, FridaUnloadPolicy unload_policy)
{
